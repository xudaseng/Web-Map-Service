    ...
    constructor(props: Props){
        ...
        this.state = {
            layerInfoData:{
                ...
                topic: '',
                url: '',
                service:{abstr:'',administrative_unit:'',contact_info:{
                    address:'',administrative_unit:'',city:'',email:'',
                    fascimile_tel:'',organization: '',person:'',position:'',
                    post_code:'',state_province:'',voice_tel: ''},
                    geoLocation:[],id:1,ip:'',keywords:'',title:'',topic:'',url:'',version:''
                }
            }
        }
    }
    ...
    public render() {
        ...
        return (
            <Layout className="_info">
                ...
                <Icon className="icon" type="search" /><b className="_info_container_header">LayerInfo</b><br/>
                    <Content className="_info_container_section">
                        <Content className="_info_container_section_content">
                            <div>
                                <img src={this.state.layerInfoData.url} alt={this.state.layerInfoData.name} />
                    ...
                    <span><b className="_info_container_section_header">Details of the layer:</b></span><br/>
                        ...
                        <br/>
                        <Icon className="icon" type="search" /><b className="_info_container_header">The service messages of the layer</b><br/>
                        <Content className="_info_container_section">
                            <Content className="_info_container_section_content">
                                ...
                                <span className="span"><Icon className="icon" type="pushpin"/><b>GeoGraphic Location：</b>{this.state.layerInfoData.service["geoLocation"]}</span><br/>
